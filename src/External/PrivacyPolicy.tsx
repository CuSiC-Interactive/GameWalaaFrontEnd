...
const RefundAndCancellation = () => {
  return (
    <div className="policy-page px-4 py-8 max-w-4xl mx-auto bg-white shadow-lg rounded-lg my-8">
      ...
      <p className="mb-4 text-gray-700">
        This privacy policy sets out how Mi Ikigai Consulting LLP uses and
        protects any information that you give Mi Ikigai Consulting LLP when you
        use this website.
      </p>

      <p className="mb-4 text-gray-700">
        Mi Ikigai Consulting LLP is committed to ensuring that your privacy is
      ...
      <p className="mb-6 text-gray-700">
        Mi Ikigai Consulting LLP may change this policy from time to time by
      ...
      <p className="text-sm italic text-gray-500 mt-8">
        Disclaimer: The above content is created at Mi Ikigai Consulting LLP’s
        sole discretion. Razorpay shall not be liable for any content provided
        here and shall not be responsible for any claims and liability that may
