...
const TermsAndConditions = () => {
  return (
    <div className="policy-page">
      ...
      <p>
        <strong>Last updated on Jun 25th 2025</strong>
      </p>
      ...
      <p>
        ...
        conditions of use, which together with our privacy policy govern Mi
        Ikigai Consulting LLP’s relationship with you in relation to this
        website.
      </p>

      <p>
        The term 'Mi Ikigai Consulting LLP' or 'us' or 'we' refers to the owner
        of the website whose registered/operational office is 17/2, Basant
        Vihar, Kanke Road, Ranchi, Jharkhand 834008. The term 'you' refers to
      ...
      <ul>
        ...
        <li>
          ...
          document without Mi Ikigai Consulting’s prior written consent.
        </li>
        <li>
      ...
      <p>
        <strong>Disclaimer:</strong> The above content is created at Mi Ikigai
        Consulting’s sole discretion. Razorpay shall not be liable for any
